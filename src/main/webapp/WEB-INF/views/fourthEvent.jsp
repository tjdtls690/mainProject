...
<c:set var="path" value="${pageContext.request.contextPath}/resources/fourthEvent"/>
<!DOCTYPE html>
<html>
<head>

<title>프레시코드- 세븐일레븐 프코스팟</title>
		...
		<div id="__layout">
			<main class="viewport" data-v-0f5971ec="">
				...
				<div class="container" style="padding-top: 182px;"
					data-v-0f5971ec="">
					<div data-v-bf4562d6="" data-v-0f5971ec="" class="container">
						<img data-v-bf4562d6=""
							src="https://s3.ap-northeast-2.amazonaws.com/freshcode/promotion/content/origin/488_20220125160450?timestamp=1645974811"
							class="img">
						<div data-v-bf4562d6="" class="btn-wrap">
							<img data-v-bf4562d6=""
								src="https://s3.ap-northeast-2.amazonaws.com/freshcode/promotion/content/origin/489_20220125160455?timestamp=1645974811"
								class="img">
							<div data-v-bf4562d6="" class="btn"></div>
						</div>
						<img data-v-bf4562d6=""
							src="https://s3.ap-northeast-2.amazonaws.com/freshcode/promotion/content/origin/490_20220125160459?timestamp=1645974811"
							class="img">
						<div data-v-bf4562d6="" class="btn-wrap">
							<img data-v-bf4562d6=""
								src="https://s3.ap-northeast-2.amazonaws.com/freshcode/promotion/content/origin/491_20220125160505?timestamp=1645974811"
								class="img">
							<div data-v-bf4562d6="" class="btn"></div>
						</div>
						<img data-v-bf4562d6=""
							src="https://s3.ap-northeast-2.amazonaws.com/freshcode/promotion/content/origin/492_20220125160512?timestamp=1645974811"
							class="img">
						<div data-v-bf4562d6="" class="btn-wrap">
							<img data-v-bf4562d6=""
								src="https://s3.ap-northeast-2.amazonaws.com/freshcode/promotion/content/origin/493_20220125160515?timestamp=1645974811"
								class="img">
							<div data-v-bf4562d6="" class="btn"></div>
						</div>
						<img data-v-bf4562d6=""
							src="https://s3.ap-northeast-2.amazonaws.com/freshcode/promotion/content/origin/494_20220125160517?timestamp=1645974811"
							class="img">
						<div data-v-bf4562d6="" class="btn-wrap">
							<img data-v-bf4562d6=""
								src="https://s3.ap-northeast-2.amazonaws.com/freshcode/promotion/content/origin/495_20220125160520?timestamp=1645974811"
								class="img">
							<div data-v-bf4562d6="" class="btn"></div>
						</div>
						<img data-v-bf4562d6=""
							src="https://s3.ap-northeast-2.amazonaws.com/freshcode/promotion/content/origin/496_20220125160523?timestamp=1645974811"
							class="img">
						<!---->
					</div>
				</div>
