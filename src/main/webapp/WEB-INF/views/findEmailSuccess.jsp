...
<c:set var="path" value="${pageContext.request.contextPath}/resources/findEmailSuccess" />
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$(document).on('click', '.button.button:even:even', function(){
			// 로그인하러 가기
		...
		$(document).on('click', '.button.button:even:odd', function(){
			// 다시시도
					...
					<article data-v-64c929d0="" data-v-1739428d="" class="find-idpw">
						<div data-v-64c929d0="" class="find-idpw__wrap">
							<header data-v-64c929d0="" class="find-idpw__header">
								<h2 data-v-64c929d0="">문자 전송 완료</h2>
								<p data-v-64c929d0="">
									휴대폰 번호로 아이디(이메일)를 보내드렸습니다.<br data-v-64c929d0=""> 문자메세지를
									확인해 주세요.
								</p>
							</header>
							<div data-v-64c929d0="" class="find-idpw__complete">
								<nav data-v-64c929d0="">
									...
									<button data-v-a1c889e0="" data-v-64c929d0="" type="button"
										title="" class="button button">
										<span data-v-a1c889e0="" class="button__wrap">비밀번호 찾으러
											가기</span>
									</button>
									<button data-v-a1c889e0="" data-v-64c929d0="" type="button"
