...
<c:set var="path" value="${pageContext.request.contextPath}/resources/myMemberSecessionSuccess"/>
<!DOCTYPE html>
<html class="">
<head>
...
$(function(){
	...
	var lastScrollTop = 0,
    	...
    	// 메인화면으로 버튼
    	$(document).on('click', '.finish-delete__buttons.row--v-center button', function(){
		...
		<div id="__layout">
			<main data-v-1739428d="" class="viewport-none-footer">
				...
				<div data-v-1739428d="" class="container">
					<div data-v-cd8405de="" data-v-1739428d="" class="finish-delete">
						<header data-v-cd8405de="" class="finish-delete__header">
							<h2 data-v-cd8405de="">
								회원 탈퇴가 <span data-v-cd8405de="">완료되었습니다.</span>
							</h2>
							<p data-v-cd8405de="">그동안 샐러딧과 함께해주셔서 감사합니다.</p>
						</header>
						<div data-v-cd8405de=""
							class="finish-delete__buttons row--v-center">
							<button data-v-a1c889e0="" data-v-cd8405de="" type="button"
								title="" class="button button--size-large button--radius-little"
								style="height: 46px;">
								<span data-v-a1c889e0="" class="button__wrap">메인화면으로</span>
							</button>
						</div>
					</div>
				</div>
