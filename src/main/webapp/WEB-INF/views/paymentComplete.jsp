...
<c:set var="path" value="${pageContext.request.contextPath}/resources/paymentComplete"/>
<!DOCTYPE html>
<html>
<head>
	...
	<div id="__nuxt">
		<div id="__layout">
			<main class="viewport" data-v-0f5971ec="">
				...
				<div class="container"
					data-v-0f5971ec="">
					<article class="checkout-finish" style="min-height: 35.5vh;"
						data-v-5a073676="" data-v-0f5971ec="">
						<!---->
						<div data-v-5a073676="">
							<header data-v-5a073676="" class="checkout-finish__header">
								<h2 data-v-5a073676="">
									<span data-v-5a073676=""></span> 주문완료!
								</h2>
								<img data-v-5a073676="" src="https://saladits3.s3.ap-northeast-2.amazonaws.com/Logo/icon_order-success%403x.png"
									alt="" class="checkout-finish__header-img">
								<p data-v-5a073676="">
									주문취소는 배송일 전날 오후 3시까지 입니다.<br>단, 오후 3시~5시 사이에는 주문 직후 5분 뒤<br>제조가
									시작되어 취소 불가합니다.
								</p>
							</header>
							<div data-v-5a073676="" class="checkout-finish__body">
								<div data-v-5a073676="" class="body__wrapper">
