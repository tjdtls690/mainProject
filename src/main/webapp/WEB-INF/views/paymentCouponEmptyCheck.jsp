...
<div class="swal2-container swal2-center swal2-backdrop-show"
	...
	<div aria-labelledby="swal2-title" aria-describedby="swal2-content"
		class="swal2-popup swal2-modal swal2-icon-question swal2-show"
		...
		<div class="swal2-content">
			<div id="swal2-content" class="swal2-html-container"
				style="display: block;">쿠폰을 선택하지 않으셨습니다. 창을 닫으시겠습니까?</div>
		...
		<div class="swal2-actions">
			<button type="button" class="swal2-cancel swal2-styled coupon-cancle" aria-label=""
				style="display: inline-block;">취소</button>
			<button type="button" class="swal2-confirm swal2-styled coupon-ok"
				aria-label=""
