...
public class DetailVO {
	...
	private int subscribe_delivery_type_summary = 2;

	public int getSubscribe_delivery_type_summary() {
		return subscribe_delivery_type_summary;
	}

	public void setSubscribe_delivery_type_summary(int subscribe_delivery_type_summary) {
		this.subscribe_delivery_type_summary = subscribe_delivery_type_summary;
	}
...
//----------------------------------------------------------------------
	...
	public String toString() {
		return "DetailVO [item_code=" + item_code + ", item_tag_main=" + item_tag_main + ", item_tag_sub="
				+ item_tag_sub + ", item_tag_event=" + item_tag_event + ", item_name=" + item_name + ", item_summary="
				+ item_summary + ", item_explain=" + item_explain + ", item_price_m=" + item_price_m
				+ ", item_price_m_sub=" + item_price_m_sub + ", item_price_l=" + item_price_l + ", item_price_l_sub="
				+ item_price_l_sub + ", item_nut=" + item_nut + ", item_image=" + item_image + ", item_info_image="
				+ item_info_image + ", item_delinfo_image=" + item_delinfo_image + ", item_info=" + item_info
				+ ", subscribe_delivery_type_summary=" + subscribe_delivery_type_summary + "]";
	}
