...
public class MyReviewWriteVO {
	...
	public String toString() {
		return "MyReviewWriteVO [seq=" + seq + ", item_code=" + item_code + ", subscribe_code=" + subscribe_code
				+ ", star=" + star + ", user_name=" + user_name + ", content=" + content + ", write_date=" + write_date
				+ ", image=" + image + ", reply=" + reply + ", tagMain=" + tagMain + ", payment_item_mapping_code="
