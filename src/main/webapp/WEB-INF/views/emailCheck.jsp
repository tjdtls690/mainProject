...
<c:if test="${check == 2 }">
	<p data-v-5781a129="" class="validation error">카카오로 가입된 계정입니다.</p>
	<input type="hidden" class="validation" name="emailCheck" id="emailCheck" value="0">
</c:if>
<c:if test="${check == 3 }">
	<p data-v-5781a129="" class="validation error">구글로 가입된 계정입니다.</p>
	<input type="hidden" class="validation" name="emailCheck" id="emailCheck" value="0">
</c:if>
<c:if test="${check == 4 }">
	<p data-v-5781a129="" class="validation error">샐러딧 이메일로 가입된 계정입니다.</p>
	<input type="hidden" class="validation" name="emailCheck" id="emailCheck" value="0">
</c:if>