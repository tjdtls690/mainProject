...
public class MyReviewSearchVO {
	...
	public String toString() {
		return "MyReviewSearchVO [seq=" + seq + ", item_code=" + item_code + ", subscribe_code=" + subscribe_code
				+ ", star=" + star + ", user_name=" + user_name + ", content=" + content + ", write_date=" + write_date
				+ ", image=" + image + ", reply=" + reply + ", payment_item_mapping_code=" + payment_item_mapping_code
				+ "]";
	}
