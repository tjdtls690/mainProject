...
<c:set var="path" value="${pageContext.request.contextPath}/resources/findInfoFinal" />
<!DOCTYPE html>
<html class="">
<head>

<title>샐러드 - 프리미엄 샐러드 배달 서비스</title>
...
<script type="text/javascript">
	...
	$(function(){
	    ...
	    $(document).on('click', '.button.button:even', function(){
	    	//로그인하러 가기
	    	$(location).attr("href", "login.do");
	    })
	    
	    $(document).on('click', '.button.button:odd', function(){
	    	//다시 시도
	    	$(location).attr("href", "findPassword.do");
	    })
	})
</script>
</head>
					...
					<article data-v-8933b0ca="" data-v-1739428d="" class="find-idpw">
						<div data-v-8933b0ca="" class="find-idpw__wrap">
							<header data-v-8933b0ca="" class="find-idpw__header">
								<h2 data-v-8933b0ca="">임시 비밀번호 발송 완료</h2>
								<p data-v-8933b0ca="">
									휴대폰 번호로 비밀번호 안내 문자를 전달했습니다.<br data-v-8933b0ca=""> 발급된 <em
										data-v-8933b0ca="" class="text-color-error">임시 비밀번호로 로그인은
										24시간 동안만 가능</em>하오니 로그인 후 <em data-v-8933b0ca=""
										class="text-color-error">반드시 비빌번호를 변경해주세요!</em>
								</p>
							</header>
							<div data-v-8933b0ca="" class="find-idpw__complete">
								<nav data-v-8933b0ca="">
									<button data-v-a1c889e0="" data-v-8933b0ca="" type="button"
										title="" class="button button">
										<span data-v-a1c889e0="" class="button__wrap">로그인하러 가기</span>
									</button>
									<button data-v-a1c889e0="" data-v-8933b0ca="" type="button"
										title="" class="button button button--outline">
										<span data-v-a1c889e0="" class="button__wrap">다시 시도</span>
									</button>
								</nav>
							</div>
						</div>
