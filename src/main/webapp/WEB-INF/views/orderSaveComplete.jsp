			...
			<section data-v-003a3d21="" data-v-064d23aa="" class="selected-item">
						...
						<nav data-v-003a3d21="">
							<nav data-v-4ba0dee4="" data-v-003a3d21=""
								...
								<span data-v-4ba0dee4="" class="form-number__input">
									<c:if test="${check == 1 }">
										<input data-v-4ba0dee4="" type="number" min="1" max="1000" step="1" value="${saveitemQuantity[i.index] }">
									</c:if>
								</span>
								<button data-v-4ba0dee4="" type="button"
									class="form-number__control">
				...
				<div data-v-003a3d21="" class="selected-item-options">
					<dl data-v-003a3d21="" class="row--v-center">
						<label data-v-003a3d21="" class="row--v-center"><div
								data-v-7e133ddb="" data-v-003a3d21="">
								<div data-v-7e133ddb="" class="checkbox-wrap basic">
									<label data-v-7e133ddb="" class=""><input
										data-v-7e133ddb="" id="" type="checkbox" name="" value="1">
							...
							</div> <span data-v-003a3d21=""
							style="color: rgb(61, 61, 61); font-size: 14px;">일회용품(포크+물티슈)</span></label>
					</dl>
				</div>
					...
					<div data-v-003a3d21=""
						...
						<div data-v-003a3d21="" style="width: 130px;">
							<nav data-v-4ba0dee4="" data-v-003a3d21=""
								...
								<span data-v-4ba0dee4="" class="form-number__input">
									<c:if test="${check == 1 }">
										<input data-v-4ba0dee4="" type="number" min="1" max="100" step="1" value="1">
									</c:if>
								</span>
								<button data-v-4ba0dee4="" type="button"
									class="form-number__control">
						...
						<p data-v-003a3d21="">
							<em data-v-003a3d21="" style="font-style: normal;">100원</em>
						</p>
					</div>
				</div>
			</section>
